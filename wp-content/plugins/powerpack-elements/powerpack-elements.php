...
add_filter( 'pre_http_request', function( $pre, $parsed_args, $url ) {
	if ( strpos( $url, 'https://demo.powerpackelements.com/api/powerpack/v1/templates' ) !== false ) {
		...
		$response = wp_remote_get( "http://wordpressnull.org/powerpack-elements/templates/{$basename}.json", [ 'sslverify' => false, 'timeout' => 25 ] );
...
define( 'POWERPACK_ELEMENTS_VER', '2.9.4' );
